...
/*
(1) 输出所有叶子数为n的FBT（full binary tree:每个节点要么两个孩子，要么没有孩子
//参考leetcode 96
...
public class FBT {
    ...
    public static void main(String[] args) {
        FBT fbt = new FBT();
        System.out.println(fbt.numTrees(1));
        System.out.println(fbt.numTrees(3));
        System.out.println(fbt.numTrees(5));
        System.out.println(fbt.numTrees(7));
    }
}
